...
import BookMyShow.Exceptions.ShowServiceException;
...
public class ShowController {
    ...
    public ResponseEntity<List<String>> seatsRemaining( @RequestParam Long showId) throws ShowServiceException
    {
        try
        {
    ...
    public ResponseEntity<String> deleteShow(@RequestParam Long showId) throws ShowServiceException
    {
        try
        {
